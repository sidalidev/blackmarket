<script>
  let products = [
...

    {
      ...
      price: 23.48,
      image:
        "https://preview.redd.it/thats-one-weird-sock-v0-1o9os2rkcqbb1.jpg?width=640&crop=smart&auto=webp&s=091e38af2aceafab855bb5599c353b872c5533c3",
      stars: 4,
      blocked: true,
    },

    {
      ...
      price: 4500.51,
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSN0zeJTmXezMEwv3-NfdZhSv5Dx0klTJctWLgKbwQlBqB9Jjrr26t-gaWxTRxyWKS5ZLU&usqp=CAU",
      stars: 4,
      blocked: false,
    },
...

    {
      ...
      price: 6012.95,
      image:
        "https://media.istockphoto.com/id/1090985526/fr/photo/les-vieilles-chaussures-avec-des-trous-dans-les-orteils-us%C3%A9s.jpg?s=1024x1024&w=is&k=20&c=PtM1fe77gWUNJMyE7aatprTnXhMswcFyq9XkVlYNdZc=",
      stars: 4,
      blocked: false,
    },
  ];
...
<button class="bg-pink-500 text-white p-4 rounded-xl">Sid</button>
...
<div class="m-16">
  {#each sorted_products as product}
    <div class="flex items-center p-8 shadow rounded-xl my-5 cursor-pointer">
